<p align="center">
  <img src="https://d26dzxoao6i3hh.cloudfront.net/items/0M0W110L142j0t2H0W2X/manta-logo.svg" alt="ACME App Logo" width="180" height="auto"/>
</p>

<h2>
  ACME
  <a href="https://travis-ci.org/hql287/ACME">
    <img src="https://travis-ci.org/hql287/ACME.svg?branch=dev" alt="Build Status">
  </a>
  <a href="https://github.com/hql287/ACME/releases/tag/v1.1.4">
...
Here's a few screenshots of ACME. [See more](https://github.com/hql287/ACME/wiki/Screenshots)
...
If you're interested in translating ACME, please see the [detailed instruction here](https://github.com/hql287/ACME/wiki/Translating-ACME).
The following languages are currently being translated, if you would like to ACME to support another language, [please submit your request here](https://github.com/hql287/ACME/issues/9).
...
macOS | Windows | Linux
-----------------| ---| ---|
<a href='https://github.com/hql287/ACME/releases/download/v1.1.4/ACME-1.1.4.dmg'>Download v1.1.4</a> | <a href='https://github.com/hql287/ACME/releases/download/v1.1.4/ACME.Setup.1.1.4.exe'>Download v1.1.4</a> | <a href='https://github.com/hql287/ACME/releases/download/v1.1.4/ACME-1.1.4-x86_64.AppImage'>Download v1.1.4</a> |

[More Download Options](https://github.com/hql287/ACME/releases)
...
Note that on Linux, some users might experience a GPU bug where the select options rendered as a black box, see [issue #128 of ACME](https://github.com/hql287/ACME/pull/128) and [issue #4322 of Electron](https://github.com/electron/electron/issues/4322). This can be fixed by disabling hardware acceleration like so:
...
### Goals
With that in mind, I know that ACME would need to satisfy these criteria:
...
* 💰 Free! :)
  ...
  If you think ACME delivers these, let me know by putting a star on this project 😉
...
* Open terminal and `cd` into the cloned folder, usually `cd ACME`.
...
* **Why did you name the project ACME? It has nothing to do with invoicing.**
...
In my case, I was inspired by the movie [Racing Extinction](http://racingextinction.com/) and by naming this project ACME, I hope to raise people's awareness on some environmental issues mentioned in the movie. You can [read more about it here](https://manta.life/about)

* **I like ACME's logo, did you design it?**
...
If you find an issue, please report it here. For everything else, please drop me a line at info@alien-tec.com

### Acknowledgement

Special thanks to [Crowdin](https://crowdin.com) for providing [an open-source license](https://crowdin.com/page/open-source-project-setup-request) for ACME.
